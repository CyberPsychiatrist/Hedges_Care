        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
          <div>
            <div className="flex items-center space-x-2 text-green-700 mb-4">
              ...
              />
              <span className="text-xl font-bold">Plant Detector</span>
            </div>
            <p className="text-green-600 text-sm mb-4">
              Revolutionize your home and and office decor using AI powered Plants Detector
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start text-green-600">
                ...
                <span className="text-sm">Kamakis along Eastern bypass , Nairobi,Kenya</span>
              </div>
              ...
              <div className="flex items-center text-green-600">
                ...
                <span className="text-sm">+254 722 990587</span>
              </div>
              <div className="flex items-center text-green-600">
