...
import DiseaseDetail from "@/components/plant/DiseaseDetail";
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-green-100">
      ...
      <div className="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-green-800 mb-2">Plants Library</h1>
          <p className="text-green-700 max-w-2xl mx-auto">
            Search through our comprehensive database of Plants, Grass, and trees.
          </p>
        </div>
              ...
              <TabsContent value="details" className="mt-0">
                {selectedDisease ? (
                  ...
                  <div className="text-center py-20">
                    <Info className="mx-auto h-12 w-12 text-gray-400" />
                    <h3 className="mt-2 text-lg font-medium text-gray-900">No Plants selected</h3>
                    <p className="mt-1 text-sm text-gray-500">Select a Plants from the list to view details.</p>
                  </div>
                )}
              </TabsContent>
            </Tabs>
